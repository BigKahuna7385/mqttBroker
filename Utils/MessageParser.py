...
class MessageParser:
    ...
    def parse_fixed_header(self, message: bytes) -> str:
    ...
    def parse_remaining_length(self, message: bytes) -> int:
        return int.from_bytes(message[1:2], "big")

    def parse_topic(self, data: bytes) -> bytes:
    ...
    def _parse_topic_length(self, data: bytes) -> int:
    ...
    def _get_message_length(self, data: bytes) -> int:
